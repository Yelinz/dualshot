...
public class MyApplicationInterface extends BasicApplicationInterface {
    ...
    public void onCaptureStarted() {
        ...
        // DUALCAM-PIP begin
        // Kick off the front-camera still (if the PIP is active) in lockstep with OC's own
        // capture, so both are as close in time as possible; see PIP_SPEC.md section D and
        // PipController.onCaptureStarted()/ImageSaver's composite choke point.
        net.sourceforge.opencamera.dualcam.PipController.onCaptureStarted();
        // DUALCAM-PIP end
    }
