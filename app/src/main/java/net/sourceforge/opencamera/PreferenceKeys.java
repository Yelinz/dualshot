...
public class PreferenceKeys {
    ...
    /** Whether to show the on-screen icon that toggles dual-camera PIP mode (see
     *  net.sourceforge.opencamera.dualcam.PipController). */
    public static final String ShowDualCameraModePreferenceKey = "preference_show_dual_camera_mode";

    // DUALCAM-PIP begin
    /** Whether the dual-camera PIP overlay is enabled (default off). Independent of
     *  ShowDualCameraModePreferenceKey, which only controls the icon's visibility.
     *  See net.sourceforge.opencamera.dualcam.PipController. */
    public static final String DualCameraPipPreferenceKey = "preference_dual_camera_pip";
    /** Persisted PIP rect (normalized floats, see net.sourceforge.opencamera.dualcam.PipController). */
    public static final String DualCameraPipRectLeftKey = "preference_dual_camera_pip_rect_left";
    public static final String DualCameraPipRectTopKey = "preference_dual_camera_pip_rect_top";
    public static final String DualCameraPipRectWidthKey = "preference_dual_camera_pip_rect_width";
    // DUALCAM-PIP end
}
